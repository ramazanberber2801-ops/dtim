...
function StepNumber({ children }: { children: React.ReactNode }) {
  return (
    <div className="w-10 h-10 rounded-full flex items-center justify-center theme-primary-button">
      <span className="font-serif text-sm font-bold">{children}</span>
    </div>
  );
}
...
function StepHelper({ icon, children, note }: { icon: React.ReactNode; children: React.ReactNode; note?: string }) {
  return (
    <div className="mt-2 flex items-center gap-2 rounded-lg border px-3 py-2 theme-card">
      {icon}
      <span className="text-xs theme-muted">{children}</span>
      {note && <span className="ml-auto text-[10px] theme-muted">{note}</span>}
    </div>
  );
}
      ...
      <div className="relative w-full max-w-md rounded-2xl shadow-2xl border-2 overflow-hidden theme-surface">
        ...
        <div className="relative px-6 py-6 theme-secondary-panel">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-3" style={{ backgroundColor: 'var(--brand-subtle)' }}>
              <Smartphone size={26} style={{ color: 'var(--brand-primary)' }} />
            </div>
            <h2 className="font-serif text-xl">Kurulum Rehberi</h2>
        ...
        <div className="p-6">
          {isSafari && (
            <div className="space-y-5">
              <div className="text-center">
                <span className="inline-block text-[10px] font-semibold uppercase tracking-wider px-3 py-1 rounded-full" style={{ backgroundColor: 'var(--brand-subtle)', color: 'var(--brand-primary)' }}>
                  Safari · iOS
                </span>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <StepHelper icon={<Share size={16} style={{ color: 'var(--brand-primary)' }} />} note="Ekranın altında">
                    Paylaş (Share)
                  </StepHelper>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <StepHelper icon={<Plus size={16} style={{ color: 'var(--brand-primary)' }} />}>
                    Ana Ekrana Ekle
                  </StepHelper>
                </div>
              </div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <StepHelper icon={<Menu size={16} style={{ color: 'var(--brand-primary)' }} />} note="Sağ üst köşe">
                    Menü (☰)
                  </StepHelper>
                </div>
              </div>
          ...
          {!isSafari && !isSamsung && (
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <div className="shrink-0">
                  <StepNumber><Menu size={18} /></StepNumber>
                </div>
                <div className="flex-1 pt-1">
                  <h3 className="text-sm font-semibold mb-1">
                    Tarayıcı menüsünü açın
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 pt-1">
                  <h3 className="text-sm font-semibold mb-1">Tamamlandı!</h3>
                  <p className="text-xs theme-muted leading-relaxed">
          ...
          <button
            onClick={onClose}
            className="theme-secondary-panel w-full mt-6 py-3 rounded-lg text-sm font-medium transition-colors"
          >
            Anladım
          </button>
        </div>
