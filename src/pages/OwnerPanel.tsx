...
export function OwnerPanel() {
  return (
    <div className="p-4 space-y-5" style={{ color: brand.text }}>
      <div
        className="rounded-3xl p-5 shadow-sm border-2 overflow-hidden relative"
        style={{
          backgroundColor: brand.secondary,
          color: brand.secondaryText,
          borderColor: mix(brand.primary, 24),
        }}
      >
        <div
          className="absolute -right-10 -top-10 w-32 h-32 rounded-full opacity-25"
        ...
        <div className="relative">
          <div className="flex items-center gap-2 mb-3">
            <div
              ...
              style={{ backgroundColor: mix(brand.primary, 25), color: brand.primary }}
            >
              <Sparkles size={20} />
            </div>
            <div>
          ...
          <p className="text-sm opacity-75 max-w-xl">
            Kontrollsenteret for organisasjoner, moduler, branding, themes, layouts, hosting og pakker.
          </p>
      ...
      <SectionCard title="Opprett organisasjon" icon={Building2}>
        <div className="space-y-3">
          <input
            disabled
            className="w-full px-4 py-3 rounded-xl border bg-white text-sm opacity-75"
            style={{ borderColor: mix(brand.primary, 22), color: brand.text }}
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              style={{ borderColor: mix(brand.primary, 30), color: brand.text }}
            >
              <Server size={16} className="inline mr-1" /> Self Hosted
            </button>
            <button
              disabled
            ...
            >
              <Cloud size={16} className="inline mr-1" /> Managed
            </button>
          </div>
        ...
        <div className="space-y-2">
          {modules.map((mod) => (
            <div
              ...
              style={{ borderColor: mix(brand.primary, 16), backgroundColor: mix(brand.primary, 4, '#FFFFFF') }}
            >
              <div>
