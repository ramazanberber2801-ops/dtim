...
const copy: Record<string, Record<string, string>> = {
  nb: { more: 'Mer', organization: 'Min organisasjon', admin: 'Administrator', visitor: 'Medlem eller besøkende', contact: 'Kontakt', documents: 'Dokumenter', members: 'Medlemmer', donations: 'Donasjoner', payments: 'Betalinger', chat: 'Chat', administration: 'Administrasjon', login: 'Logg inn', settings: 'Innstillinger og moduler' },
  en: { more: 'More', organization: 'My organization', admin: 'Administrator', visitor: 'Member or visitor', contact: 'Contact', documents: 'Documents', members: 'Members', donations: 'Donations', payments: 'Payments', chat: 'Chat', administration: 'Administration', login: 'Sign in', settings: 'Settings and modules' },
  tr: { more: 'Daha fazla', organization: 'Kuruluşum', admin: 'Yönetici', visitor: 'Üye veya ziyaretçi', contact: 'İletişim', documents: 'Belgeler', members: 'Üyeler', donations: 'Bağışlar', payments: 'Ödemeler', chat: 'Sohbet', administration: 'Yönetim', login: 'Giriş yap', settings: 'Ayarlar ve modüller' },
  ar: { more: 'المزيد', organization: 'مؤسستي', admin: 'مسؤول', visitor: 'عضو أو زائر', contact: 'اتصل بنا', documents: 'المستندات', members: 'الأعضاء', donations: 'التبرعات', payments: 'المدفوعات', chat: 'الدردشة', administration: 'الإدارة', login: 'تسجيل الدخول', settings: 'الإعدادات والوحدات' },
  ur: { more: 'مزید', organization: 'میری تنظیم', admin: 'ایڈمن', visitor: 'رکن یا وزیٹر', contact: 'رابطہ', documents: 'دستاویزات', members: 'ارکان', donations: 'عطیات', payments: 'ادائیگیاں', chat: 'چیٹ', administration: 'انتظامیہ', login: 'لاگ اِن', settings: 'ترتیبات اور ماڈیولز' },
};
