...
const da: Dictionary = {
  'nav.home':'Hjem','nav.donation':'Donation','nav.contact':'Kontakt',
  'contact.title':'Kontakt','contact.subtitle':'Kontakt os','contact.location':'FYSISK ADRESSE','contact.address':'Organisationens adresse','contact.directions':'FIND VEJ','contact.askTitle':'Stil et spørgsmål','contact.askSubtitle':'Send dit spørgsmål via WhatsApp','contact.askBody':'Har du et spørgsmål? Kontakt organisationen via WhatsApp, så hjælper vi dig hurtigst muligt.','contact.askButton':'SPØRG VIA WHATSAPP','contact.staff':'Vores kontaktpersoner','contact.noStaff':'Der er endnu ikke registreret nogen kontaktpersoner.','contact.call':'Ring',
  'home.changeCity':'Skift by','home.searchCity':'Søg efter by...','home.useLocation':'Brug min placering','home.nextPrayer':'Næste','home.loadingPrayer':'Henter bedetider...','home.todayProgram':'Dagens program','home.upcomingActivities':'Kommende aktiviteter','home.noUpcomingActivities':'Ingen kommende aktiviteter.','home.news':'Nyheder','home.noNews':'Ingen nyheder endnu.',
  'install.title':'Installér appen','install.description':'Føj den til startskærmen for hurtig adgang','install.button':'Installér','install.close':'Luk',
  'common.loading':'Indlæser...','common.close':'Luk','common.save':'Gem','common.saving':'Gemmer...',
  'recovery.title':'Vælg en ny adgangskode','recovery.password':'Ny adgangskode','recovery.repeat':'Gentag ny adgangskode','recovery.show':'Vis adgangskode','recovery.tooShort':'Adgangskoden skal være på mindst 6 tegn.','recovery.noMatch':'Adgangskoderne er ikke ens.','recovery.noConnection':'Ingen forbindelse til systemet.','recovery.failed':'Adgangskoden kunne ikke gemmes: ','recovery.success':'Adgangskoden er gemt. Du kan nu logge ind med den nye adgangskode.',
  'login.title':'Administratorlogin','login.email':'E-mail','login.password':'Adgangskode','login.submit':'Log ind','login.invalid':'Forkert e-mail eller adgangskode.','login.forgotPassword':'Glemt adgangskode?','login.temporaryPassword':'Du er logget ind med en midlertidig adgangskode. Vælg en permanent adgangskode, før du fortsætter.','login.showPasswords':'Vis adgangskoder','login.savePassword':'Gem ny adgangskode','login.passwordUpdateFailed':'Adgangskoden kunne ikke opdateres: ',
  'forgot.title':'Nulstil adgangskode','forgot.description':'Indtast din e-mailadresse. Du modtager et sikkert link til at vælge en ny adgangskode.','forgot.emailRequired':'E-mail er påkrævet.','forgot.sendFailed':'E-mailen kunne ikke sendes: ','forgot.sent':'Et link til nulstilling er sendt til din e-mailadresse.','forgot.submit':'Send nulstillingslink',
  'installGuide.title':'Installér appen','installGuide.subtitle':'Føj appen til startskærmen','installGuide.iosShareTitle':'Tryk på Del','installGuide.iosShareBody':'Tryk på Del-knappen nederst i Safari.','installGuide.share':'Del','installGuide.bottomOfScreen':'Nederst på skærmen','installGuide.addHomeTitle':'Vælg Føj til hjemmeskærm','installGuide.iosAddHomeBody':'Rul ned i menuen, og tryk på “Føj til hjemmeskærm”.','installGuide.addHome':'Føj til hjemmeskærm','installGuide.doneTitle':'Færdig!','installGuide.doneBody':'Appikonet vises nu på startskærmen, og appen kan åbnes direkte derfra.','installGuide.openMenuTitle':'Åbn browsermenuen','installGuide.samsungMenuBody':'Tryk på menuikonet i Samsung Internet.','installGuide.topRight':'Øverst til højre','installGuide.menu':'Menu','installGuide.samsungAddHomeBody':'Vælg “Føj side til” og derefter startskærmen.','installGuide.browserMenu':'Browsermenu','installGuide.genericBody':'Åbn browsermenuen, og vælg “Føj til startskærm” eller “Installér app”.','installGuide.doneShort':'Appikonet vises nu på startskærmen.','installGuide.understood':'Forstået',
  'activity.label':'Aktivitet','activity.contact':'Kontaktperson','activity.addCalendar':'Føj til kalender','activity.addReminder':'Tilføj påmindelse','activity.call':'Ring','activity.sms':'SMS','activity.whatsapp':'WhatsApp','activity.email':'E-mail',
  'donation.title':'Støt vores arbejde','donation.subtitle':'Dit bidrag støtter organisationens aktiviteter og arbejde.','donation.copyNumber':'Kopiér nummer','donation.copied':'Kopieret','donation.openVipps':'Åbn i Vipps','donation.openingVipps':'Åbner Vipps...','donation.vippsDisabled':'Vipps-linket er deaktiveret. Du kan kopiere nummeret for at bidrage.','donation.note':'Alle bidrag bruges til organisationens aktiviteter, tilbud og samfundsnyttige arbejde.'
};

const tr: Dictionary = { ...en, 'nav.home':'Ana Sayfa','nav.donation':'Bağış','nav.contact':'İletişim','home.news':'Haberler','home.noNews':'Henüz haber yok.','common.loading':'Yükleniyor...','common.close':'Kapat','common.save':'Kaydet','common.saving':'Kaydediliyor...','login.title':'Yönetici Girişi','login.email':'E-posta','login.password':'Şifre','login.submit':'Giriş Yap','forgot.title':'Şifreyi Sıfırla','donation.title':'Çalışmalarımızı Destekleyin' };
const ar: Dictionary = { ...en, 'nav.home':'الرئيسية','nav.donation':'تبرع','nav.contact':'اتصل بنا','home.news':'الأخبار','common.loading':'جارٍ التحميل...','common.close':'إغلاق','common.save':'حفظ','login.title':'تسجيل دخول المسؤول','donation.title':'ادعم عملنا' };
const ur: Dictionary = { ...en, 'nav.home':'ہوم','nav.donation':'عطیہ','nav.contact':'رابطہ','home.news':'خبریں','common.loading':'لوڈ ہو رہا ہے...','common.close':'بند کریں','common.save':'محفوظ کریں','login.title':'ایڈمن لاگ اِن','donation.title':'ہمارے کام کی حمایت کریں' };
